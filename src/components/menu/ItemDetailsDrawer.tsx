      ...
      {isOpen && (
        <div className="fixed inset-0 z-100 flex justify-start overflow-hidden">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md sm:max-w-lg bg-white h-full shadow-2xl border-r border-white/10 z-10 flex flex-col"
          >
            {/* Header / Banner Area */}
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-6 sm:p-10 space-y-10">
              ...
              <section className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold text-gray-900">{t('admin.ingredients_label')}</h3>
                </div>
                    ...
                    {getIngredientList(itemDescription).length > 0 ? (
                      getIngredientList(itemDescription).map((ingredient, idx) => (
                        ...
                        >
                          ...
                          <span className="text-sm sm:text-base font-bold text-gray-900 leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity">
                            {ingredient}
                          </span>
                        </motion.div>
                      ))
              ...
              {/* Quality Badges */}
              <section className="pt-6 border-t border-gray-200 grid grid-cols-2 gap-4">
                <div className="p-4 rounded-3xl bg-primary/5 border border-primary/10 flex flex-col gap-2 group hover:bg-primary/10 transition-colors">
                  ...
                  <p className="text-xs font-bold text-gray-900">{t('menu.fresh_daily_desc') || "يتم التحضير بمكونات طازجة يومياً"}</p>
                </div>
                <div className="p-4 rounded-3xl bg-secondary/5 border border-secondary/10 flex flex-col gap-2 group hover:bg-secondary/10 transition-colors">
                  ...
                  <p className="text-xs font-bold text-gray-900">{t('menu.quality_desc') || "نضمن لك أعلى مستويات الجودة"}</p>
                </div>
              </section>
            ...
            <div className="p-6 sm:p-10 border-t border-gray-200 bg-white">
              <button
